    ...
    <div className="space-y-8 animate-fade-in pb-24 text-slate-300">
        <div className="bg-surfaceHighlight p-6 rounded-3xl border border-white/5">
            ...
            <ol className="list-decimal list-inside space-y-3 text-sm marker:text-primary marker:font-bold">
                ...
                <li><strong className="text-white">Купи Инструменты:</strong> Зайди в "Финансы" &rarr; "Инструменты" и купи VPN/Proxy. Это увеличит доход за клик.</li>
                <li><strong className="text-white">Найми Команду:</strong> Вкладка "Бизнес" &rarr; "Команда". Найми первого воркера.</li>
                <li><strong className="text-white">Купи Софт:</strong> Вкладка "Бизнес" &rarr; "Софт". <span className="text-red-400">Без софта воркеры не работают!</span></li>
            </ol>
        </div>
        ...
        <div className="grid grid-cols-1 gap-4">
             <div className="bg-surfaceHighlight p-5 rounded-3xl">
                 ...
                 <p className="text-xs leading-relaxed">
                     ...
                     <br/>3. Лей Трафик (Бизнес &rarr; Трафик), чтобы умножать их доход.
                 </p>
             </div>
             ...
             <div className="bg-surfaceHighlight p-5 rounded-3xl">
                 ...
                 <p className="text-xs leading-relaxed">
                     Временные задачи. Вкладываешь деньги &rarr; Ждешь &rarr; Есть шанс потерять всё или получить х2-х5.
                 </p>
             </div>
             ...
             <div className="bg-surfaceHighlight p-5 rounded-3xl">
                 ...
                 <p className="text-xs leading-relaxed">
                     ...
                     Заходи в <span className="text-white font-bold">Финансы &rarr; Обмыв</span> и покупай бизнесы (Шаурма, Мойка), чтобы расширить банк.
                 </p>
             </div>
        </div>
    </div>
